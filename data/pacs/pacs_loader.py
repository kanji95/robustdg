...
class PACS(BaseDataLoader):
    def __init__(
        self, args, list_train_domains, root, transform=None, data_case="train"
    ):
    ...
    def _get_data(self):
        ...
        for domain in self.list_train_domains:
            ...
            pacs_img_trans = torch.zeros(
                (pacs_imgs.shape[0], self.args.img_c, self.args.img_w, self.args.img_h)
            )
